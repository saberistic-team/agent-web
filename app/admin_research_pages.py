...
def render_admin_company_research_page(
    *,
    ...
    archive_button_class = admin_archive_action_class(archived=bool(company.get("archived_at")))
    error_html = ""
    if error_message:
        error_html = (
...
def render_admin_contact_research_page(
    *,
    ...
    archive_button_class = admin_archive_action_class(archived=bool(contact.get("archived_at")))
