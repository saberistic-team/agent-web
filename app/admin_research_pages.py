...
from app.admin_layout import render_admin_shell, render_archive_restore_button
...
def render_admin_company_research_page(
    *,
    ...
    archive_button = render_archive_restore_button(label=archive_label, is_restore=is_restore)
