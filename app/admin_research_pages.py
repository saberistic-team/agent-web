...
def render_admin_company_research_page(
    *,
    ...
    archive_btn_class = archive_action_button_class(is_archived=bool(company.get("archived_at")))
    error_html = ""
    if error_message:
        error_html = (
...
def render_admin_contact_research_page(
    *,
    ...
    archive_btn_class = archive_action_button_class(is_archived=bool(contact.get("archived_at")))
