...
def render_admin_company_research_page(
    *,
    ...
    archive_label = "Restore company" if archived else "Archive company"
    archive_form = render_admin_archive_action_form(
        form_action=f"/admin/companies/{company_id}/{archive_action}",
        csrf_token=csrf_token,
        label=archive_label,
        archived=archived,
    )
...
def render_admin_contact_research_page(
    *,
    ...
    archive_action = "restore" if archived else "archive"
    archive_label = "Restore contact" if archived else "Archive contact"
    archive_form = render_admin_archive_action_form(
        form_action=f"/admin/contacts/{contact_id}/{archive_action}",
        csrf_token=csrf_token,
        label=archive_label,
        archived=archived,
    )
