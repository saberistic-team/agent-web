...
def admin_company_research(
    ...
    settings = get_settings()
    csrf_token = _session_csrf_for_forms(request, settings)
    if settings.admin_preview_enabled and company_id in PREVIEW_CRM_DETAIL_IDS:
...
def admin_contact_research(
    ...
    settings = get_settings()
    csrf_token = _session_csrf_for_forms(request, settings)
    if settings.admin_preview_enabled and contact_id in PREVIEW_CRM_DETAIL_IDS:
