...
def test_legacy_013_upgrades_through_015(pg_conn: psycopg.Connection) -> None:
    ...
    assert upgraded == ["014", "015", "016", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026"]
...
def _upgrade_legacy_013(conn: psycopg.Connection) -> None:
    ...
    assert apply_migrations(conn) == ["014", "015", "016", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026"]
