...
def test_admin_research_page_renderers_cover_company_and_contact(
    ...
    archived_company = {**company, "archived_at": now.isoformat()}
    ...
    assert 'class="admin-action-btn admin-action-btn--restore"' in archived_company_html
    ...
    archived_contact = {**contact, "archived_at": now.isoformat()}
    ...
    assert 'class="admin-action-btn admin-action-btn--restore"' in archived_contact_html
