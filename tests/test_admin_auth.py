...
def test_rate_limit_uses_forwarded_ip_when_trusted(
    ...
    monkeypatch.setenv("ADMIN_TRUSTED_PROXY_IPS", "10.0.0.0/8,172.16.0.0/13")
    monkeypatch.setenv("ADMIN_LOGIN_RATE_LIMIT", "2")
    with shared_rate_limiter(rate_limit_store):
        with patch("app.proxy_trust.immediate_peer_host", return_value="10.0.0.1"):
            headers = {"X-Forwarded-For": "203.0.113.77, 172.64.0.1"}
            ...
            other_ip_headers = {"X-Forwarded-For": "203.0.113.88, 172.64.0.1"}
