...
the same middleware entry point; see `docs/ADMIN_CACHE_POLICY.md` (#337).
...
and validation failures retain headers. Cache isolation (#337) is applied in
the same middleware hook; see `docs/ADMIN_CACHE_POLICY.md`.
