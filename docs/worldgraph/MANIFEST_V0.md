...
> **Canonical spec:** Issue #199 docs supersede this spike-aligned summary.
> See [WORLD_MANIFEST_V0.md](./WORLD_MANIFEST_V0.md) and
...
- Canonical docs: [WORLD_MANIFEST_V0.md](./WORLD_MANIFEST_V0.md)
