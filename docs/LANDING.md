...
at `/brief`. Operators browse submissions at `/admin/briefs`. Stripe promotion codes
are supported at checkout ([#197](https://github.com/saberistic-team/agent-web/issues/197));
