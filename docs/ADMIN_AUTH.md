...
| `ADMIN_PREVIEW_SEED` | Optional | Root seed for mock admin randomization (stable CI default `338001`). |
| `ADMIN_PREVIEW_REFERENCE_AT` | Optional | Frozen UTC reference time for preview fixtures (CI default `2026-07-14T12:00:00+00:00`). |
| `ADMIN_PREVIEW_FIXTURE_VERSION` | Optional | Preview fixture schema version; bump when regenerating screenshot baselines. |
